      ...
      <form id="contact_info_form" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST">
        ...
        <section id="download-section">
            <div>
                ...
                <button type="button" class="download-btn" data-action="download_footprint_csv" style="border-radius:99px; padding:10px 20px; margin-right:10px;">Download footprint table</button>
            </div>
