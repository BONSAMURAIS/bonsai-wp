    ...
    <div id="main-content">
        ...
        <section id="co2-form-result">            
            ...
            <section id="analysis-wrapper">
                                    ...
                                    <div class="unit-select-wrapper">
                                        ...
                                        <div class="arrow-wrapper">
                                            <label class="select" for="unit">
                                                <svg class="select-arrow unit-arrow" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div id="compared-product-analysis" class="tile-wrapper" style="display: none;">
